...
//Code Provided By KaupenJoe
//https://github.com/Tutorials-By-Kaupenjoe/Fabric-Tutorial-1.21.X/blob/18-fullArmorEffect/src/main/java/net/kaupenjoe/tutorialmod/item/custom/ModArmorItem.java

public class ModArmorItem extends ArmorItem {
    private static final Map<RegistryEntry<ArmorMaterial>, List<StatusEffectInstance>> MATERIAL_TO_EFFECT_MAP =
            (new ImmutableMap.Builder<RegistryEntry<ArmorMaterial>, List<StatusEffectInstance>>())
                    .put(net.pdotudotsdot.cumulonimbus.item.custom.ModArmorMaterials.SKY_RUBY_ARMOR_MATERIAL,
                            List.of(new StatusEffectInstance(StatusEffects.JUMP_BOOST, 1, 1, true, false),
                                    new StatusEffectInstance(StatusEffects.SLOW_FALLING, 1, 0, true, false))).build();
